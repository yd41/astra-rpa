...
from app.utils.ocr.config import VAT_INVOICE_CONFIG
from app.utils.ocr.error_policy import classify_ocr_failure

logger = get_logger(__name__)


class VATInvoiceOCRClient(XFYunOCRClient):
    """Client for VAT invoice recognition using XunFei OCR API."""

    def __init__(self):
        super().__init__(VAT_INVOICE_CONFIG)
