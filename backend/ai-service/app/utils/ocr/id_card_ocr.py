...
from app.utils.ocr.config import ID_CARD_CONFIG
from app.utils.ocr.error_policy import classify_ocr_failure

logger = get_logger(__name__)


class IDCardOCRClient(XFYunOCRClient):
    """Client for ID card recognition using XunFei OCR API."""

    def __init__(self):
        super().__init__(ID_CARD_CONFIG)
