...
class BusinessCardOCRClient(XFYunOCRClient):
    """Client for business card recognition using XunFei OCR API."""

    def __init__(self):
        super().__init__(BUSINESS_CARD_CONFIG)
