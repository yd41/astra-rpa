...
# 文件相关错误
FILE_PATH_ERROR: ErrorCode = ErrorCode(BizCode.LocalErr, _("{}表格文件路径错误，仅支持 .xlsx 文件"))
...
# 表格筛选相关错误
FILTER_CONDITION_NOT_SUPPORTED: ErrorCode = ErrorCode(BizCode.LocalErr, _("暂不支持该筛选条件：{}"))
FILTER_CONDITION_INVALID: ErrorCode = ErrorCode(BizCode.LocalErr, _("条件异常，请输入正确的条件！"))
DATA_PROCESS_MISSING_PARAM: ErrorCode = ErrorCode(BizCode.LocalErr, _("第{}列数据处理缺少参数"))
DATA_PROCESS_PARAM_INVALID: ErrorCode = ErrorCode(BizCode.LocalErr, _("参数异常，请输入正确的参数！{}{}"))
